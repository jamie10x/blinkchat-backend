...
type Message struct {
	...
	IsDeleted     bool    `json:"isDeleted" db:"-"`
...
type CreateMessageRequest struct {
	...
	Attachment *string    `json:"attachmentUrl,omitempty" binding:"omitempty,url"`
}
...
// UpdateMessageRequest represents a content edit request.
